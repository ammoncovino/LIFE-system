...
### Guest Areas
High-touch surfaces (handrails, door handles, restroom fixtures, encounter station counters): wipe with approved disinfectant a minimum of three times per day — opening, midday, closing — and any time visible soiling is observed. Floors: spot-clean throughout the day; full mop at close. Trash: empty before any bin reaches three-quarters full; never let waste sit visible to guests.

---

## Frequency and Schedule

| Area | Minimum Frequency | Documented At |
|------|-------------------|---------------|
| Acrylic windows | Daily — opening pass and closing pass | Cleaning log |
| Exhibits (full) | Per the species' care card | Cleaning log |
| Food prep surfaces | After every use | Food prep log |
| Guest high-touch | 3× per day minimum | Cleaning log |
| Restrooms | Hourly check; full clean 3× per day | Cleaning log |
| Floors (guest areas) | Spot-clean throughout day; full mop at close | Cleaning log |

Deeper cleaning frequencies for individual exhibits live on the species care card, not in this Part. If a species care card and this Part disagree, the care card wins for that species.

---

## Responsibility

- **Animal care staff** are responsible for cleaning inside exhibits and around feeding stations on their assigned route.
- **Guest-facing staff** are responsible for guest area cleaning during their shift.
- **Closing crew** is responsible for the end-of-day full clean and verifying the cleaning log is complete.
- **Upper managers** verify completion at open and close.

No cleaning task is "someone else's job." If you see something out of standard, you fix it or report it immediately.

---

## Documentation

Every cleaning task on the schedule must be recorded in the cleaning log with the staff initials, time, and area. An empty log entry is treated as the task not done. See Part 1 Rule 6 — documentation is the proof that the work was done.

---

## Supply Storage

- Approved cleaning products are stored in the designated cleaning supply area only. Never on food prep surfaces, never in guest areas, never inside exhibits.
- Virkon is mixed fresh per label. Old solution is discarded — do not top off.
- Blue rags are dedicated to acrylic. They do not get used on any other surface.
- Cross-contamination of rags or sponges between guest areas, food prep, and exhibits is prohibited.

---

## Escalation

If a cleaning standard cannot be met (supplies out, equipment broken, area unsafe), the staff member reports it to an upper manager immediately. Cleaning is not deferred without an upper manager's acknowledgement on the log.

Repeat cleaning failures move to the discipline path described in Part 9 and Part 19.

---

## Cross-References

- Exhibit ground maintenance and biome rules: Part 4 (Animal Care).
- Zero Waste collection from cleaning is governed by Part 6.
- Closing checklist verification of cleaning: Part 18.
...
## PENDING TOTEMS — TO BE BUILT FROM OWNER'S ORIGINAL WORK

The following 8 species require totems built to LIFE system standards. These will be written by the owner using the 8-question totem format established by the Master Totems. No external sources. No internet-sourced content. Mechanism-first, observation-based.
